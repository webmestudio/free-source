...
class Upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__).'/language') && file_exists(dirname(__FILE__).'/language/class.upload.' . $lang . '.php')) {
            $translation = null;
            include(dirname(__FILE__).'/language/class.upload.' . $lang . '.php');
